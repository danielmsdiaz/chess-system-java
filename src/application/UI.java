...
public class UI {
	...
	public static void printBoard(ChessPiece[][] pieces, boolean[][] possibleMoves) {  //printa o tabuleiro pintando as posicoes possiveis
		for (int i = 0; i < pieces.length; i++) {
			System.out.print((8 - i) + " ");
			for (int j = 0; j < pieces.length; j++) {  
	...
	private static void printPiece(ChessPiece piece, boolean background) { //imprime as pecas
    	if(background == true) {
